		...
		_getCoordinates		: function( position ) {
			...
			if( this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					case 'outleft':
						return {
							'-webkit-transform'	: 'translateX(-300px) translateZ(-250px) rotateY(45deg)',
							'-moz-transform'	: 'translateX(-300px) translateZ(-250px) rotateY(45deg)',
							'-o-transform'		: 'translateX(-300px) translateZ(-250px) rotateY(45deg)',
							'-ms-transform'		: 'translateX(-300px) translateZ(-250px) rotateY(45deg)',
							'transform'			: 'translateX(-300px) translateZ(-250px) rotateY(45deg)',
							'opacity'			: 0,
							'visibility'		: 'hidden'
						};
						break;
