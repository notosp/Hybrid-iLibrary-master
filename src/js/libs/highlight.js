...
!function($) {
		...
		function innerHighlight(node, pat, ignore) {
			...
			if (node.nodeType == 3) {
				...
				for (var ii = 0; ii < patternCount; ii++) {
					...
					if (pos >= 0) {
						var spannode = document.createElement('memo');
						spannode.className = 'highlight';
						spannode.style.backgroundColor='rgba(255,90,90,0.5)';
						//spannode.style.backgroundColor='transparent';
	...
	$.fn.removeHighlight = function() {
		return this.find("memo.highlight").each(function() {
