...
//document.getElementById('back').setAttribute('onclick','window.history.back()');
...
var PDFView = {
  ...
  switchSidebarView: function pdfViewSwitchSidebarView(view, openSidebar) {
    ...
    var memoView = document.getElementById('memoView');

    var thumbsButton = document.getElementById('viewThumbnail');
    var outlineButton = document.getElementById('viewOutline');
    var attachmentsButton = document.getElementById('viewAttachments');
    var bookmarkButton = document.getElementById('loadBookmark');
    var memoButton = document.getElementById('loadMemo');
    console.log(view)
    switch (view) {
      case 'thumbs':
        ...
        memoButton.classList.remove('toggled');
      ...
      case 'bookmark':
        ...
        if (bookmarkButton.getAttribute('disabled')) {
          return;
        }
        break;
        ...
        attachmentsView.classList.add('hidden');
        bookmarkView.classList.add('hidden');
        memoButton.classList.add('toggled');
...
var ThumbnailView = function thumbnailView(container, id, defaultViewport) {
  ...
  this.getPageDrawContext = function thumbnailViewGetPageDrawContext() {
    ...
    page.id = 'page' + id;
    page.className = 'centre';
    page.innerHTML=id;

    div.setAttribute('data-loaded', true);

    ring.appendChild(canvas);
    ring.appendChild(page);
...
var DocumentOutlineView = function documentOutlineView(outline) {
  // var outlineView = document.getElementById('outlineView');
  var outlineView = document.getElementById('toc_toc');
...
function webViewerInitialized() {
  ...
  document.getElementById('loadBookmark').addEventListener('click',
    function() {
      PDFView.switchSidebarView('bookmark');
    });
  document.getElementById('loadMemo').addEventListener('click',
    function() {
      PDFView.switchSidebarView('memo');
    });
...
function updateViewarea() {
  ...
  var tot = $('#numPages').html().split('of ')
  var persen = (parseInt(pageNumber)/parseInt(tot[1]))*100;
  //console.log(pageNumber,numPages,tot[1])
  $('#page_progress').css('width',persen+'%')
  ...
  var a1 = href.split('#');
  var a = a1[1].split('&')
  document.getElementById('viewBookmark').setAttribute('onclick',"action_bookmark('"+a[0]+"')")
  is_bookmark(a[0])
  window.curr_page = a1[1]
...
// window.addEventListener("dblclick", eventDoubleClick, false);
window.addEventListener('contextmenu', eventDoubleClick, false);
window.addEventListener("mouseup", eventMouseDown, false);

function eventMouseDown(e){
  try{
    // console.log(e)
    if(e.srcElement.id=="thumbnailView"){
      $('#context-menu').css('visibility','hidden');
      $('#menu').hide();
    }
    if(e.srcElement.id=="viewer"){
      $('#context-menu').css('visibility','hidden');
      $('#menu').hide();
    }
    if(e.srcElement.id=="toolbarViewer"){
      $('#context-menu').css('visibility','hidden');
      $('#menu').hide();
    }
    if(e.srcElement.className=='textLayer'){
      $('#context-menu').css('visibility','hidden');
      $('#menu').hide();
    }
  }catch(e){
...
function getClickPosition(e) {
    ...
    // xPosition = e.clientLeft;
    // yPosition = e.clientTop;
    var max =$(window).width()-210;
    ...
    $('#context-menu').css('top',y).css('left',x).css('visibility','visible').css('z-index','999');
